...
const links = [
    ...
    { url: '/detail_du_an', changefreq: 'monthly', priority: 0.6 },
    ...
    { url: '/landuseplan', changefreq: 'monthly', priority: 0.6 },
    ...
    { url: '/administrative-maps', changefreq: 'monthly', priority: 0.6 },
